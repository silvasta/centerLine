...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('task', default='line', help= 'ctdet | ddd | multi_pose | exdet')
    self.parser.add_argument('--dataset', default='roboline', help='random_small | random_large')
    self.parser.add_argument('--detector', default='line_detection')
    self.parser.add_argument('--annot_name', default='roboline')
    ...
    self.parser.add_argument('--demo_out', default='',help='path where the output is saved"')
...
#       opt.val_intervals = 100000000
  ...
  def update_dataset_info_and_set_heads(self, opt, dataset):
    ...
    if opt.task == 'line':
      if opt.annot_name == 'random_4_categories':
        opt.num_classes = 4
  ...
  def init(self, args=''):
    default_dataset_info = {
      #todo
      'roboline': {'default_resolution': [640, 480], 'num_classes': 1, 
                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                'dataset': 'roboline'},
      'line_4_cat': {'default_resolution': [640, 480], 'num_classes': 4, 
                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                'dataset': 'line_4_cat'},
      'line_2_cat': {'default_resolution': [640, 480], 'num_classes': 2, 
                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                'dataset': 'line_2_cat'}
    }
    class Struct:

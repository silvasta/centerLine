...
#python main.py line  --gpus 0,1 --dataset line_2_cat --annot_name rand_line_1k --exp_id $exp_id
# python main.py line --debug 4 --dataset line_2_cat --annot_name rand_line_1k --exp_id $exp_id
  
# and test --vis_thresh 0
python test_line.py line   --debug 4 --demo_out $demo_out --resume --dataset line_2_cat --annot_name rand_line_1k --exp_id $exp_id 

# and demo
#python demo.py line --dataset line_2_cat --debugger_theme black --demo $image_path --demo_out $demo_out --resume --exp_id $exp_id --debug 4

...
python main2.py line  --gpus 0,1 --dataset line_4_cat --annot_name random_4_categories_10k --exp_id random_4_categories_10k
#python main.py line --debug 4 --dataset line_4_cat --annot_name random_4_categories --exp_id random_4_categories_10k
  
# and test
python test.py line  --resume --dataset line_4_cat --annot_name random_4_categories_10k --exp_id random_4_categories_10k
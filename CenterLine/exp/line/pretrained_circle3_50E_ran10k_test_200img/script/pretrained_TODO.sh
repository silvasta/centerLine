...
exp_id=pretrained_circle3_50E_ran10k_test_200img
data=roboline
model=/scratch_net/biwidl213/silvasta/bachelor-thesis-line-detection/CenterLine/exp/line/random_10k_circle3/model_50_epochs/model_last.pth

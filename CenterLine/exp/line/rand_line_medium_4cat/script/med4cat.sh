...
# python main2.py line  --gpus 0,1 --dataset line_4_cat --annot_name rand_line_20k --exp_id rand_line_medium_4cat
# #python main.py line --debug 4 --dataset line_4_cat --annot_name rand_line_20k --exp_id rand_line_medium_4cat
  
# # and test
# python test.py line  --resume --dataset line_4_cat --annot_name rand_line_20k --exp_id rand_line_medium_4cat
python test_line.py line  --vis_thresh 0 --debug 4 --demo_out $demo_out --resume --dataset line_2_cat --annot_name rand_line_20k --exp_id $exp_id 
# and demo
# python demo.py line --debugger_theme black --demo $image_path --demo_out $demo_out --resume --debug 4

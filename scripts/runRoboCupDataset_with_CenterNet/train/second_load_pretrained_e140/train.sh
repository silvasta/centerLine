...
python main.py ctdet --load_model /scratch_net/biwidl213/silvasta/detectors/CenterNet/models/ctdet_coco_resdcn18.pth  --dataset robocup --exp_id robocup_train_resdcn18 --arch resdcn_18 --master_batch 15 --lr 1.25e-4  --gpus 0,1 --num_workers 16
